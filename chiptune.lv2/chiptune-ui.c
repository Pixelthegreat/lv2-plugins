...
static const char *wave_type_enumeration[] = {
	"Sine",
	"Square",
	"Triangle",
	"Sawtooth",
...
static const char *duty_cycle_enumeration[] = {
	"12.5%",
	"25%",
	"50%",
	NULL,
};
static const char *envelope_enumeration[] = {
	"Off",
	"On",
	NULL,
};
...
static ui_element_t *root_element = UI_BOX_INIT(UI_ORIENTATION_VERTICAL, {
	...
	UI_BOX_INIT(UI_ORIENTATION_HORIZONTAL, {
		UI_LABEL_INIT("Wave Type", .base.halign = UI_ALIGN_START),
		UI_BUTTON_INIT(wave_type_enumeration,
			       .color = UI_COLOR_INDEX_DARK1,
			       .base.port = 3),
		UI_ELEMENT_END,
	}),
	UI_BOX_INIT(UI_ORIENTATION_HORIZONTAL, {
		UI_LABEL_INIT("Duty Cycle", .base.halign = UI_ALIGN_START),
		UI_BUTTON_INIT(duty_cycle_enumeration,
			       .color = UI_COLOR_INDEX_DARK1,
			       .base.port = 4),
		UI_ELEMENT_END,
	}),
	UI_BOX_INIT(UI_ORIENTATION_HORIZONTAL, {
		UI_LABEL_INIT("Envelope", .base.halign = UI_ALIGN_START),
		UI_BUTTON_INIT(envelope_enumeration,
			       .color = UI_COLOR_INDEX_DARK1,
			       .base.port = 5),
		UI_ELEMENT_END,
	}),

	UI_SEPARATOR_INIT(UI_ORIENTATION_HORIZONTAL, 200),

	UI_BOX_INIT(UI_ORIENTATION_HORIZONTAL, {

		UI_BOX_INIT(UI_ORIENTATION_VERTICAL, {
			UI_LABEL_INIT("Attack"),
			UI_DIAL_INIT(0, 0.05f, 2.f,
...
/* descriptors */
UI_DESCRIPTOR_LIST = {
	UI_DESCRIPTOR(CHIPTUNE_URI, x11),
};
